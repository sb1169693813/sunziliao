                            ...
                            <div class="line-full t-line-36 h40">
                                <div class="wp100wrap  h40">
                                    ...
                                    <?php if(isset($sportitemBaseList['level'])){?>
                                    	<?php  switch($sportitemBaseList['level']) { case 1: echo '入门级';break; case 2: echo '初级';break; case 3: echo '中级';break; case 4: echo '高级';break; case 5: echo '挑战级';break; } ?>
                                    <?php } else { echo ''; } ?>
                                    </div>
                                </div>
                            </div>										
                            <div class="line-full t-line-36 h40">
                                <div class="wp100wrap  h40">
                                    ...
                                    <?php if(isset($sportitemBaseList['type'])){?>
                                    	<?php  switch($sportitemBaseList['type']) { case 1: echo '热身';break; case 2: echo '练习';break; case 3: echo '拉伸';break; } ?>
                                    <?php } else { echo ''; } ?></div>
                                </div>
                            </div>
                            ...
                            <div class="line-full t-line-36 h120">
                                <div class="wp100wrap  h120" style="height:auto !important;min-height:120px;">
                                    ...
                                    <div class="input-50-r" style="height:auto !important;min-height:100px;">
                                    	<!--  
                                        <textarea style="overflow-x:auto;overflow-y:auto" class="wp100wrap h100" cols="12" rows="12"><?php ?>                                       
                                        </textarea>
                                        -->
