                            ...
                            <div class="line-full t-line-36 h120">
                                <div class="wp100wrap  h120" style="height:auto !important;min-height:120px;">
                                    ...
                                    <div class="input-50-r" style="height:auto !important;min-height:100px;">
                                        	...
                                        	<!--//查看1,编辑2  
											<textarea  style="overflow-x:auto;overflow-y:auto" class="wp100wrap h100" cols="12" rows="12" name="intro" id="intro"><?php ?></textarea>                                       	
                                        	-->
                                        <?php  if($actiontype == 2) { echo "<textarea  style='overflow-x:auto;overflow-y:auto' class='wp100wrap h100' cols='12' rows='12' name='intro' id='intro'>"; echo isset($sportitemBaseList['intro']) ? $sportitemBaseList['intro']:null; echo "</textarea>"; } ?>
                                    <?php if($actiontype == 1) { echo '<div class="wp100wrap h100" style="height:auto !important;min-height:100px;">'; echo isset($sportitemBaseList['intro']) ? $sportitemBaseList['intro']:null; echo "</div>"; }?>
