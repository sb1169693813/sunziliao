...
//				  }
 ...
 if(isset($trainingplanOutlineList)){foreach ($trainingplanOutlineList as $toList){?>
				...
				<td><?php  switch ($toList['type']) { case 1: echo '徒手训练'; break; case 2: echo '健身房设备'; break; case 3: echo '家庭器械'; break; case 4: echo 'HIIT'; break; case 5: echo '体育舞蹈'; break; case 6: echo '特殊小器械'; break; case 7: echo 'Cross fit'; break; } ?></td>
                <td><?php  switch($toList['level']) { case 1: echo '入门级'; break; case 2: echo '初级'; break; case 3: echo '中级'; break; case 4: echo '高级'; break; case 5: echo '挑战级'; break; } ?></td>
                <td><?php
 switch ($toList['bodypart']) { case 1: echo '体适能训练'; break; case 2: echo '全身偏上肢'; break; case 3: echo '全身偏下肢'; break; case 4: echo '全身偏躯干'; break; case 5: echo '上肢下肢'; break; case 6: echo '上肢躯干'; break; case 7: echo '躯干下肢'; break; } ;?></td>
                <td class="<?php echo $toList['auditstatus']==-1?'fred':'';?>"><?php  switch ($toList['auditstatus']) { case 0: echo '未提交 '; break; case 1: echo '审核中'; break; case 2: echo '已审核'; break; case -1: echo '未通过'; break; } ?></td>
                <td><?php echo date('Y-m-d H:i',strtotime($toList['obj_createdate']));?></td>
                <td><?php  if($toList['auditdate'] != '') { echo date('Y-m-d H:i',strtotime($toList['auditdate'])); } else { echo '--'; } ;?></td>
                <td>
                <!--  
...
已审核  只能查看        
                ...
                <a href="<?php echo U('OutlineList/view', array('outline_id'=>$toList['id']));?>" class="a1">查看</a>
                
               <?php  ?>
                
                <?php if($toList['auditstatus'] == 2) { echo '<a href="" class="a1 none">编辑</a>'; } else { echo '<a href=" '; echo U('OutlineList/update', array('outline_id'=>$toList['id'])); echo ' " class="a1">编辑</a>'; } ?>
                <?php if($toList['auditstatus'] == 2 ) { echo '<a href="javascript:void(0);" class="a1 none commit">提交</a>'; } else { echo '<a href="javascript:void(0);" class="a1 commit" onclick="commit('.$toList['id'].');">提交</a>'; } ?>
                </td>
               </tr>
    		   <?php }}?>
              </tbody>
