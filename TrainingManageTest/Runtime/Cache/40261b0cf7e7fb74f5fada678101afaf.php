                        ...
                        <div>                    
                            <div class="wp48 m20 fleft mb15">
                                <ul class="wp100 fleft">
                                    ...
                                    <li class="tableg lihidden"><?php  switch ($s1['grouptype']) { case 1: echo $s1['count'].'个/'.$s1['groupcount'].'组'; break; case 2: echo $s1['count'].'秒/'.$s1['groupcount'].'组'; break; } ?></li>
                        ...
                        <div class="<?php echo isset($s2[$i])?'':'none';?>">                    
                            <div class="wp48 m20 fleft mb15">
                                <ul class="wp100 fleft">
                                    ...
                                    <li class="tableg lihidden"><?php  switch ($s2[$i]['grouptype']) { case 1: echo $s2[$i]['count'].'个/'.$s2[$i]['groupcount'].'组'; break; case 2: echo $s2[$i]['count'].'秒/'.$s2[$i]['groupcount'].'组'; break; } ?></li>
