                            ...
                            <div class="wp96auto">
                                ...
                                <div class="line-full t-line-36 h40">
                                    <div class="wp100wrap  h40">
                                        ...
                                        <?php if(isset($trainingplanOutlineList['type'])){ switch ($trainingplanOutlineList['type']) { case 1: echo '徒手训练'; break; case 2: echo '健身房设备'; break; case 3: echo '家庭器械'; break; case 4: echo 'HIIT'; break; case 5: echo '体育舞蹈'; break; case 6: echo '特殊小器械'; break; case 7: echo 'Cross fit'; break; } } else { echo ''; } ?>
                                        </div>
                                    </div>
                                </div>
                                <!-- 行3-->
                                ...
                                <div class="line-full t-line-36 h40">
                                    <div class="wp100wrap  h40">
                                        ...
                                        <div class="input-50-r">
                                        <?php if(isset($trainingplanOutlineList['level'])){ switch ($trainingplanOutlineList['level']) { case 1: echo '入门级'; break; case 2: echo '初级'; break; case 3: echo '中级'; break; case 4: echo '高级'; break; case 5: echo '挑战级'; break; } } else { echo ''; } ?>
                                        </div>
                                    </div>
                                </div>
                                <!-- 行4-->
                                <div class="line-full t-line-36 h40">
                                    <div class="wp100wrap  h40">
                                        ...
                                        <div class="input-50-r">
                                            <div class="input-50-r">
                                            <?php if(isset($trainingplanOutlineList['bodypart'])){ switch ($trainingplanOutlineList['bodypart']) { case 1: echo '体适能训练'; break; case 2: echo '全身偏上肢'; break; case 3: echo '全身偏下肢'; break; case 4: echo '全身偏躯干'; break; case 5: echo '上肢下肢'; break; case 6: echo '上肢躯干'; break; case 7: echo '躯干下肢'; break; } }?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
