                        ...
                        <table class="table-100">
                            ...
                            <tr>
                                ...
                                <td class="<?php echo $sbList['auditstatus']==-1?'fred':'';?>">
                                	<?php  switch ($sbList['auditstatus']) { case 1: echo '待审核'; break; case 2: echo '已审核'; break; case -1: echo '未通过'; break; } ?>
                                </td>
                                ...
                                <td>   
                                	...
                                	-->
					                <?php  if($sbList['auditstatus']==2) { echo "<a href="; echo U('SportitemBaseCheckList/check',array('id'=>$sbList['id'])); echo " class='a1'>查看</a>"; } else { echo "<a href="; echo U('SportitemBaseCheckList/check',array('id'=>$sbList['id'])); echo " class='a1'>审核</a>"; } ?>
                                </td>
                            </tr>
                            <?php }}?>                          
                            </tbody>
