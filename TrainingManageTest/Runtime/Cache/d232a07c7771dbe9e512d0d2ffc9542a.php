                        ...
                        <?php if(isset($trainingplanOutlineDetailSportitemList1)){foreach($trainingplanOutlineDetailSportitemList1 as $todsList1){?>
                            <div class="wp48 m20 fleft mb15">
                                <ul class="wp100 fleft" >
                                    ...
                                    <li class="tableg lihidden"><?php  switch ($todsList1['grouptype']) { case 1: echo $todsList1['count'].'个/'.$todsList1['groupcount'].'组'; break; case 2: echo $todsList1['count'].'秒/'.$todsList1['groupcount'].'组'; break; } ?></li>
                        ...
                        <?php if(isset($trainingplanOutlineDetailSportitemList2)){foreach($trainingplanOutlineDetailSportitemList2 as $todsList2){?>
                            <div class="wp48 m20 fleft mb15">
                                <ul class="wp100 fleft">
                                    ...
                                    <li class="tableg lihidden"><?php  switch ($todsList2['grouptype']) { case 1: echo $todsList2['count'].'个/'.$todsList2['groupcount'].'组'; break; case 2: echo $todsList2['count'].'秒/'.$todsList2['groupcount'].'组'; break; } ?></li>                                 
                        ...
                        <div class="<?php echo count($trainingplanOutlineDetailSportitemList3)>0?'pdt10':''?>">
                            ...
                            <div class="wp48 m20 fleft mb15">
                                <ul class="wp100 fleft">
                                    ...
                                    <li class="tableg lihidden"><?php  switch ($todsList3['grouptype']) { case 1: echo $todsList3['count'].'个/'.$todsList3['groupcount'].'组'; break; case 2: echo $todsList3['count'].'秒/'.$todsList3['groupcount'].'组'; break; } ?></li>                                    
