                    ...
                    <div class="wp96auto">
                        ...
                        <table class="table-100">
                            ...
                            <tr>
                                ...
                                <td><?php  switch ($tbList['equipmenttype']) { case 1: echo '徒手训练'; break; case 2: echo '健身房训练'; break; case 3: echo '家庭健身'; break; case 4: echo 'HIIT'; break; case 5: echo '体育舞蹈'; break; case 6: echo '特殊小器械'; break; case 7: echo 'Cross fit'; break; } ?></td>
                                ...
                                <td class="<?php echo $tbList['status']==-1?'fred':'';?>"><?php  switch ($tbList['status']) { case 0: echo '未提交'; break; case 1: echo '待审核'; break; case 2: echo '已审核'; break; case -1: echo '未通过'; break; } ?></td>
                                ...
                                <td>
                                    <!--  
                                    <a href="<?php ?>" class="a1">审核</a>
                                	-->
                                	<?php  if($tbList['status']==2) { echo "<a href="; echo U('TrainingplanBaseCheckList/check',array('id'=>$tbList['id'])); echo " class='a1'>查看</a>"; } else { echo "<a href="; echo U('TrainingplanBaseCheckList/check',array('id'=>$tbList['id'])); echo " class='a1'>审核</a>"; } ?>
                                </td>
                            </tr>
                            <?php }}?>
                            </tbody>
