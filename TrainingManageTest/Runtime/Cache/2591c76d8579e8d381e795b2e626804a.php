        ...
        <div class="line-full content-wrap">
            ...
            <div class="cls_tab_nav">
                        ...
                        <div class="wp96auto">
                            ...
                            <table class="table-100">
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <?php  switch ($tbList['equipmenttype']) { case 1: echo '徒手训练'; break; case 2: echo '健身房训练'; break; case 3: echo '家庭健身'; break; case 4: echo 'HIIT'; break; case 5: echo '体育舞蹈'; break; case 6: echo '特殊小器械'; break; case 7: echo 'Cross fit'; break; } ?></td>
                                    <td><?php  switch ($tbList['level']) { case 1: echo '入门级'; break; case 2: echo '初级'; break; case 3: echo '中极'; break; case 4: echo '高级'; break; case 5: echo '挑战级'; break; } ?></td>
                                    <td><?php  switch ($tbList['bodypart']) { case 1: echo '心肺耐力'; break; case 2: echo '肌肉适能'; break; case 3: echo '柔韧'; break; case 4: echo '平衡'; break; case 5: echo '灵敏'; break; case 6: echo '全身'; break; case 7: echo '全身偏上'; break; case 8: echo '全身偏下'; break; case 9: echo '全身偏躯干'; break; case 10: echo '上肢下肢'; break; case 11: echo '上肢躯干'; break; case 12: echo '下肢躯干'; break; case 13: echo '上肢'; break; case 14: echo '躯干'; break; case 15: echo '下肢'; break; } ?></td>
                                    <td class="<?php echo $tbList['status']==-1?'fred':'';?>"><?php  switch ($tbList['status']) { case 0: echo '未提交'; break; case 1: echo '审核中'; break; case 2: echo '已审核'; break; case -1: echo '未通过'; break; } ?></td>
                                    <td><?php echo date('Y-m-d H:i',strtotime($tbList['obj_createdate']));?></td>
					                <td><?php  if($tbList['auditdate'] != '') { echo date('Y-m-d H:i',strtotime($tbList['auditdate'])); } else { echo '--'; } ;?></td>
                                    <td>
                                    <!--  
               ...
               <a href="<?php  ?>" class="a1">查看</a>
                    -->
                 <?php if($tbList['status'] == 1) { echo '<a href="" class="a1 none">查看</a>'; } else { echo '<a href=" '; echo U('TrainingplanBaseList/view', array('trainingplan_base_id'=>$tbList['id'])); echo ' " class="a1">查看</a>'; } ?>                                            
                <?php if($tbList['status'] == 2) { echo '<a href="" class="a1 none">编辑</a>'; } else { echo '<a href=" '; echo U('TrainingplanBaseList/update', array('trainingplan_base_id'=>$tbList['id'])); echo ' " class="a1">编辑</a>'; } ?>
                <?php if($tbList['status'] == 2) { echo '<a href="javascript:void(0);" class="a1 none commit">提交</a>'; } else { echo '<a href="javascript:void(0);" class="a1 commit" onclick="commit('.$tbList['id'].');">提交</a>'; } ?>
                </td>
