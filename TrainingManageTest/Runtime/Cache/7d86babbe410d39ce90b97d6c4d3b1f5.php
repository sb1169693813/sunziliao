...
//				  }
        ...
        <div class="line-full content-wrap">
            ...
            <div class="line-full content-blue1 ">
                ...
                <div class="wp96auto mt20 ft14 fgree1 fleft h40">
                    ...
                    <span id="circle">2</span> <span class="w130 fleft"> <a class="fgray" href="javascript:void(0);" onclick="doTrainingplanBaseDetailSportitemgroup()">动作设计 >> </a> </span>
				...
				-->
                    <div class="line-full content">
                        <div class="wp96auto">
                        <!-- 行 0-->
                        	<div class="line-full  <?php echo isset($trainingplanBaseList['auditreply'])?'':'none';?>">
                                <div class="wp100wrap ">
                                    <div class="t-20-r">审核批注：</div>
                                    <div class="input-50-r fred " style="height:auto;text-indent: 0px;"><?php echo isset($trainingplanBaseList['auditreply'])?trim($trainingplanBaseList['auditreply']):null;?></div>
                                </div>
                            </div>
                            <!-- 行 1-->
                            ...
                            <!-- 行9-->
                            <div class="line-full t-line-36 h40">
                                <div class="wp100wrap  h40 mb10 pd10" style="border-bottom:1px solid #000; ">
 ...
 $trainingplanConfigList['warmupstatus'] = isset($trainingplanConfigList['warmupstatus'])?trim($trainingplanConfigList['warmupstatus']):''; if($trainingplanConfigList['warmupstatus'] == 1) { echo 'checked="checked"'; } ?>     
                                        ...
                                        -->
                                        <div class="fleft w190 h50">+&nbsp;<input type="text" name="sportitemgroupcount" id="sportitemgroupcount"  value="<?php echo isset($trainingplanConfigList['sportitemgroupcount'])? trim($trainingplanConfigList['sportitemgroupcount']):NULL ;?>" placeholder="" class="w166">
                                        </div>
                        ...
                        <!--               
                            <a href="javascript:void(0);" id="update" class="blue">下&nbsp;&nbsp;一 &nbsp; &nbsp;步</a>
                            <a href="javascript:void(0);" id="view" class="blue">下&nbsp;&nbsp;一 &nbsp; &nbsp;步</a>
                            -->
                            <input type="button" id="update" class="blue" value="下  一  步"/> 
                            <input type="button" id="view" class="blue" value="下  一  步"/>
...
<script>
    $(function () {
    	...
    	if(<?php echo $actiontype;?> == 1)
    	{
			...
			$("#coursestarget").attr('disabled',true);
			//bodypart
			...
			//targetmuscle
			$("#targetmuscle").attr('disabled',true);
			//kcal
			$("#kcal").attr('disabled',true);
			//referenceurl
			$("#referenceurl").attr('disabled',true);
			//warmupstatus
			$("#warmupstatus").attr('disabled',true);
			//sportitemgroupcount
			$("#sportitemgroupcount").attr('disabled',true);
			//stretchstatus
			$("#stretchstatus").attr('disabled',true);
			//ability1
			$("#ability1").attr('disabled',true);
			$("#ability2").attr('disabled',true);
			$("#ability3").attr('disabled',true);
			$("#ability4").attr('disabled',true);
			$("#ability5").attr('disabled',true);
			//隐藏编辑的下一步按钮
			$("#update").addClass("none");
			$("#view").click(function(){
				var url = "<?php echo U('TrainingplanBaseDetailSportitemgroup/index');?>";
    ...
    {
    	<?php SessionData::setPageData('TrainingplanBaseDetailSportitemgroup', 'trainingplan_base_id',$trainingplanBaseList['id']);?>
		var url = "<?php echo U('TrainingplanBaseDetailSportitemgroup/index');?>";
    	window.location.href = url;
    }
</script>
